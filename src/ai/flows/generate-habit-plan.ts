...
const prompt = ai.definePrompt({
  ...
  The difficulty should increase gradually. Start with something very easy on Day 1 and build up to a more solid practice by Day 21.

  For example, if the habit is "Read more books", a plan could be:
  Day 1: "Read for 5 minutes."
  Day 2: "Read for 7 minutes."
  ...
  Day 10: "Read for 20 minutes without distractions."
  ...
  Day 21: "Read a chapter of a book."

  Generate the plan now for the habit: "{{habitName}}".`,
});
